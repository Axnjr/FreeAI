...
export default function Navbar() {
    ...
    return (
        <nav className="pp pl-4 2xl:max-w-[90%] m-auto  absolute border dark:border-neutral-900 border-neutral-200 bg-white dark:bg-black z-32 top-0 left-0 right-0 flex items-center justify-between">
